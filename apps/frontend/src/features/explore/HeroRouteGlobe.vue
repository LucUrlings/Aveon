...
<template>
  <div class="hero-globe">
    ...
    <div v-if="routes" class="hero-globe-caption"><span>Live preview</span><strong>{{ routes.origin.city }} · {{ routes.origin.code }}</strong><small>{{ routes.isComplete ? `${routes.destinations.length} current direct destinations` : `${routes.destinations.length}+ routes in this quick preview` }}</small></div>
